...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="./css/style_add_prod.css">
        <link rel="stylesheet" href="./css/style_ger_users.css">
        <link rel="stylesheet" href="./css/style_ger_prod.css">
            ...
            <div class="content">
                ...
                <div id="adicionar-produto-content" class="adicionar produto">
                    ...
                    <div class="infoProd">
                        ...
                        <form action="./config_dashboard/add_prod.php" method="POST">
                            <div class="container-input">
                                ...
                                <div class="inputBox">
                                    <input type="text" name="valor" id="valor" class="inputUser" oninput="validarNumeroDecimal(this)" required>
                                    <label for="valor" class="labelInput">Valor do Produto</label>
                                </div>

                                <div class="inputBox">
                                    <input type="text" name="valor_antigo" id="valor_antigo" class="inputUser" oninput="validarNumeroDecimal(this)" required>
                                    <label for="valor_antigo" class="labelInput">Valor Antigo do Produto</label>
                                </div>

                                <div class="inputBox">
                                    <label for="lancamento"><b>Data de Lançamento</b></label>
                                    <input type="date" name="lancamento" id="lancamento" required>
                                </div>

                                <div class="inputBox">
                                    <input type="text" name="publisher" id="publisher" class="inputUser" required>
                                    <label for="publisher" class="labelInput">Publisher do Produto</label>
                                </div>

                                <div class="inputBox">
                                    <input type="text" name="pagina" id="pagina" class="inputUser" required>
                                    <label for="pagina" class="labelInput">Pagina do Produto</label>
                                </div>
                                ...
                                <div class="inputBox">
                                    <!-- <input type="text" name="tipo_prod" id="tipo_prod" class="inputUser" required>-->
                                    <label for="tipo_prod"><b>Tipo de Produto</b></label>
                                    <select name="tipo_prod" id="tipo_prod">
                                        <option name="jogo" value="0">Jogo</option>
                                        <option name="gift-card" value="1">Gift Card</option>
                                    </select>
                                </div>
                            </div>
                ...
                <div id="user-manage-content">
                    ...
                    <div class="container-users">
                        <?php
                            ...
                            $sql_resultado = $mysqli->query($sql_users);

                            if($sql_resultado->num_rows > 0){
                                while($usuario_row = $sql_resultado->fetch_assoc()){
                                    ?>
                                        <div class="single-user">
                                            <div class="single-user-name">
                                                <label>Nome</label>
                                                <p><?php echo $usuario_row['nome'] ?></p>
                                            </div>

                                            <div class="single-user-email">
                                                <label>Email</label>
                                                <p><?php echo $usuario_row['email'] ?></p>
                                            </div>

                                            <div class="single-user-nascimento">
                                                <label>Data de Nascimento</label>
                                                <p><?php echo $usuario_row['nascimento'] ?></p>
                                            </div>

                                            <div class="single-user-criacao">
                                                <label>Data de Criação</label>
                                                <p><?php echo $usuario_row['data_criacao'] ?></p>
                                            </div>

                                            <div class="single-user-tipo">
                                                <?php 
                                                    if($usuario_row['tipo_user'] == 'admin'){
                                                        echo '<label style="color: rgb(224, 52, 124);">', $usuario_row["tipo_user"] ,'</label>';
                                                    }else{
                                                        echo '<label style="color: var(--color-sub-text);">', $usuario_row["tipo_user"], '</label>';
                                                    }
                                                ?>
                                            </div>
                                        </div>
                                        ...
                                        <form action="#" id="account-form">
                                            <div class="account-modify">
                                                <button style="display: none;" action="submit" id="edit-account" name="edit-account"></button>
                                            ...
                                            <div class="account-modify">
                                                <button style="display: none;" action="submit" id="delete-account" name="delete-account"></button>
                ...
                </div><!--gerenciar-usuarios-->
                
                <div id="prod-manage-content">
                    <div class="titulo-secao">
                    ...
                    <div class="container-manage-prod">
                        <?php
                            include_once('../php/config.php');

                            $sql_prod = 'SELECT * FROM produto';
                            $sql_resultado = $mysqli->query($sql_prod);

                            if($sql_resultado->num_rows > 0){
                                while($row_prod = $sql_resultado->fetch_assoc()){
                                    ?>
                                        <div class="single-prod">
                                            <div class="single-user-name">
                                                <label>Nome</label>
                                                <p><?php echo $row_prod['nome'] ?></p>
                                            </div>

                                            <div class="single-valor">
                                                <label>Valor</label>
                                                <p><?php echo $row_prod['valor'] ?></p>
                                            </div>

                                            <div class="single-valor-antigo">
                                                <label>Valor Antigo</label>
                                                <p><?php echo $row_prod['valor_antigo'] ?></p>
                                            </div>

                                            <div class="single-lancamento">
                                                <label>Lancamento</label>
                                                <p><?php echo $row_prod['lancamento'] ?></p>
                                            </div>

                                            <div class="single-publisher">
                                                <label>Publisher</label>
                                                <p><?php echo $row_prod['publisher'] ?></p>
                                            </div>

                                            <div class="single-pagina">
                                                <label>Pagina</label>
                                                <p><?php echo $row_prod['pagina'] ?></p>
                                            </div>

                                            <div class="single-imagem">
                                                <label>Imagem</label>
                                                <p><?php echo $row_prod['imagem'] ?></p>
                                            </div>

                                            <div class="single-tipo-prod">
                                                <label>Tipo Prod</label>
                                                <p><?php echo $row_prod['tipo_prod'] ?></p>
                                            </div>

                                            <div class="single-comprados">
                                                <label>Comprados</label>
                                                <p><?php echo $row_prod['comprados'] ?></p>
                                            </div>
                                        </div>
                ...
                <script>
                    ...
                    function validarNumeroDecimal(input) {
                        ...
                        // Faz com que apenas 1 ponto decimal seja aceito
                        const pontos = input.value.match(/\./g);
