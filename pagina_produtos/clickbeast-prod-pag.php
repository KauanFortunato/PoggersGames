    ...
    <body>
        <div class="grid-container">
            <div class="background-game">
                <img src="../produtos/click-beast/clickbeast-background.jpg" alt="">
            </div>
            ...
            <div class="imagens-produto">
                <div class="slides-produto">
                    <img src="../produtos/click-beast/clickbeast-1.jpg" alt="slide 1">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/click-beast/clickbeast-2.jpg" alt="slide 2">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/click-beast/clickbeast-3.jpg" alt="slide 3">
                </div>
            </div>
            ...
            <div class="preview-img">
                <div class="previews">
                    <img src="../produtos/click-beast/clickbeast-1.jpg" alt="slide 1" onclick="slideAtual(1)">
                </div>

                <div class="previews">
                    <img src="../produtos/click-beast/clickbeast-2.jpg" alt="slide 2" onclick="slideAtual(2)">
                </div>

                <div class="previews">
                    <img src="../produtos/click-beast/clickbeast-3.jpg" alt="slide 3" onclick="slideAtual(3)">
                </div>
            </div>
            ...
            <div class="informacao-produto">
                ...
                <div class="requisitos-game">
                    <ul>
                        <li>
                            <p>SO: Qualquer coisa com tela</p>
                        </li>
                        <li>
                            <p>Processador: Processador de calculadora</p>
                        </li>
                        <li>
                            <p>Memória: 1 Kb</p>
                        </li>
                        <li>
                            <p>Gráficos: Torradeira elétrica</p>
                        </li>
                        <li>
                            <p>Armazenamento: 31 MB</p>
                        </li>
                    </ul>
                </div>
            </div>
