    ...
    <body>
        <div class="grid-container">
            <div class="background-game">
                <img src="../produtos/bully/background-bully.jpg" alt="">
            </div>
            ...
            <div class="imagens-produto">
                <div class="slides-produto">
                    <video width="600" height="337" controls>
                        <source src="../produtos/bully/Bully_ Scholarship Edition Official Trailer.mp4" type="video/mp4">
                        Seu navegador não suporta o elemento de vídeo.
                    </video>
                </div>

                <div class="slides-produto">
                    <img src="../produtos/bully/1.webp" alt="slide 2">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/bully/2.webp" alt="slide 3">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/bully/3.webp" alt="slide 5">
                </div>
            </div>
            ...
            <div class="preview-img">
                ...
                <div class="previews">
                    <img src="../produtos/bully/1.webp" alt="slide 2" onclick="slideAtual(2)">
                </div>

                <div class="previews">
                    <img src="../produtos/bully/2.webp" alt="slide 3" onclick="slideAtual(3)">
                </div>

                <div class="previews">
                    <img src="../produtos/bully/3.webp" alt="slide 4" onclick="slideAtual(4)">
                </div>
            </div>
            ...
            <div class="informacao-produto">
                ...
                <div class="requisitos-game">
                    <ul>
                        ...
                        <li>
                            <p>Intel Pentium 4 (3+ GHZ) / AMD Athlon 3000+</p>
                        </li>
                        <li>
                            <p>Memória: 1GB de RAM</p>
                        </li>
                        <li>
                            <p>Gráficos: Suporta DirectX 9.0c Shader 3.0, Nvidia 6800 ou 7300 ou superior, ATI Radeon X1300 ou superior</p>
                        </li>
                        <li>
                            <p>Armazenamento: 4,7 GB de espaço livre</p>
                        </li>
                    </ul>
                </div>
            </div>
