    ...
    <body>
        <div class="grid-container">
            <div class="background-game">
                <img src="../produtos/skyrim/skyrim-background.png" alt="">
            </div>
            ...
            <div class="imagens-produto">
                <div class="slides-produto">
                    <video width="600" height="337" controls>
                        <source src="../produtos/skyrim/trailerSKSE.mp4" type="video/mp4">
                        Seu navegador não suporta o elemento de vídeo.
                    </video>
                </div>

                <div class="slides-produto">
                    <img src="../produtos/skyrim/skyrim0.png" alt="slide 0">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/skyrim/skyrim1.png" alt="slide 1">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/skyrim/skyrim2.png" alt="slide 2">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/skyrim/skyrim3.png" alt="slide 3">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/skyrim/skyrim4.png" alt="slide 4">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/skyrim/skyrim5.png" alt="slide 5">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/skyrim/skyrim6.png" alt="slide 6">
                </div>

                <div class="slides-produto">
                    <img src="../produtos/skyrim/skyrim7.png" alt="slide 7">
                </div>
            </div>
            ...
            <div class="preview-img">
                <div class="previews">
                    <img src="../produtos/skyrim/video-game.png" alt="slide 0" onclick="slideAtual(1)">
                </div>

                <div class="previews">
                    <img src="../produtos/skyrim/skyrim0.png" alt="slide 1" onclick="slideAtual(2)">
                </div>

                <div class="previews">
                    <img src="../produtos/skyrim/skyrim1.png" alt="slide 2" onclick="slideAtual(3)">
                </div>

                <div class="previews">
                    <img src="../produtos/skyrim/skyrim2.png" alt="slide 2" onclick="slideAtual(4)">
                </div>

                <div class="previews">
                    <img src="../produtos/skyrim/skyrim3.png" alt="slide 3" onclick="slideAtual(5)">
                </div>

                <div class="previews">
                    <img src="../produtos/skyrim/skyrim4.png" alt="slide 4" onclick="slideAtual(6)">
                </div>

                <div class="previews">
                    <img src="../produtos/skyrim/skyrim5.png" alt="slide 5" onclick="slideAtual(7)">
                </div>

                <div class="previews">
                    <img src="../produtos/skyrim/skyrim6.png" alt="slide 6" onclick="slideAtual(8)">
                </div>

                <div class="previews">
                    <img src="../produtos/skyrim/skyrim7.png" alt="slide 7" onclick="slideAtual(9)">
                </div>
            </div>
            ...
            <div class="informacao-produto">
                ...
                <div class="requisitos-game">
                    <ul>
                        <li>
                            <p>Sistema Operativo: Windows 7/8.1/10/11 (versão de 64 bits)</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p>Gráficos: NVIDIA GTX 470 1GB /AMD HD 7870 2G</p>
                        </li>
                        <li>
